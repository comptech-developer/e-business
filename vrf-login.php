...
<h4 class="card-title mt-2">Verify Token</h4>
</header>
<article class="card-body">
 
<div class="form-group">
<label>Enter PIN</label>
<input type="text" id="verificationCode" name="verificationCode"  class="form-control" placeholder="">
...
<div class="form-group">
<button type="submit" id="send" class="btn btn-danger btn-block btn"> verify  </button>
</div> <!-- form-group// -->      
...
<script type="text/javascript" src="script/verify-login.js"></script>
