...
<aside class="col-sm-3  col-md-3 text-white " style="margin-left: 200px;">
...
<div class="btn-group ">
<a class="btn btn-facebook" title="Facebook" target="_blank" href="#"><i class="fab fa-facebook-f "></i></a>
